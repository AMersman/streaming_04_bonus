...
def callback(ch, method, properties, body):
    ...
    nation = str(body.decode)
    title = nation.title()
    # write message to nation
    with open('nation.csv', 'a') as file:
        writer = csv.writer(file, delimiter = ',')
        writer.writerow([nation, title])
...
def main(hn: str = "localhost", qn: str = "queue_name_a"):
